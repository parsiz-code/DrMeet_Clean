        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CenterDoctorId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CenterDoctorServicePricing_CenterDoctorsSelected_CenterDoctorId",
                        column: x => x.CenterDoctorId,
                        principalTable: "CenterDoctorsSelected",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CenterDoctorServicePricing_CenterDoctorId_ProviderServicesId",
                table: "CenterDoctorServicePricing",
                columns: new[] { "CenterDoctorId", "ProviderServicesId" },
                unique: true);
