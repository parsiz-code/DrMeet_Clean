...
namespace DrMeet.Persistence.EF.Migrations
{
    ...
    [Migration("20251007062456_remove-centerId-DoctorId-AddCenterDoctorId-CenterDoctorServiceOnlineConsultation")]
    partial class removecenterIdDoctorIdAddCenterDoctorIdCenterDoctorServiceOnlineConsultation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DrMeet.Domain.Centers.CenterDoctorServiceOnlineConsultation", b =>
                {
                    ...
                    b.HasIndex("CenterDoctorId", "ServicesAvailableId")
                        .IsUnique()
                        .HasFilter("[CenterDoctorId] IS NOT NULL");
