            ...
            modelBuilder.Entity("DrMeet.Domain.Centers.CenterDoctorsDepartmantSelected", b =>
                {
                    ...
                    b.HasIndex("CenterId", "DoctorId", "CenterDepartmentId")
                        .IsUnique()
                        .HasFilter("[CenterId] IS NOT NULL AND [DoctorId] IS NOT NULL AND [CenterDepartmentId] IS NOT NULL");
