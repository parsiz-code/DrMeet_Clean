...
public static class UpdateCommentBlogEndPoint
{
    public class EndPoint : BaseEndpoint, IEndpoint
    {
        public void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapPost($"{ApiInfo.Prefix}/UpdateCommentBlog", handler: async (
                    IBlogService service,
                      [FromBody] UpdateCommentBlogDto request,
                ...
                ) =>
            {
                ...
                var result = await service.UpdateCommentBlogAsync(request, Id, httpContext.User.GetAuthorizedUserType().ToEnum<UserType>());
             ...
             .WithTags(ApiInfo.Tag).AddEndpointFilter(new ValidationFilter<UpdateCommentBlogDto>());
