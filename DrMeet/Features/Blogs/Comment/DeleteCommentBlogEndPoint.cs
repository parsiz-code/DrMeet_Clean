...
public static class DeleteCommentBlogEndPoint
{
    public class EndPoint : BaseEndpoint, IEndpoint
    {
        public void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapPost($"{ApiInfo.Prefix}/DeleteCommentBlog", handler: async (
                    IBlogService service,
                      [FromBody] DeleteBlogCommentDto request,
                ...
                ) =>
            {
                ...
                var result = await service.DeleteCommentBlogAsync(request,DoctorId);
             ...
             .WithTags(ApiInfo.Tag).AddEndpointFilter(new ValidationFilter<DeleteBlogCommentDto>());
