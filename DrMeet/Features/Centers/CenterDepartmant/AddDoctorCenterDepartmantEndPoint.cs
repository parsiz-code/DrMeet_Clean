...
public static class AddDoctorCenterDepartmantEndPoint
{
    public class EndPoint : BaseEndpoint, IEndpoint
    {
        public void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapPost($"{ApiInfo.Prefix}/AddDoctorCenterDepartmant", handler: async (
                    ICenterService service,
                    IUserService userService,
                    [FromBody] AddDoctorCenterDto request,
                ...
                ) =>
            {
                ...
                var result = await service.AddDoctorCenterAsync(request);
