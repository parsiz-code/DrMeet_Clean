...
public static class CreateCommentCenterEndPoint
{
    public class EndPoint : BaseEndpoint, IEndpoint
    {
        public void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapPost($"{ApiInfo.Prefix}/CreateCommentCenter", handler: async (
                    ICenterService service,
                      [FromBody] CreateCommentCenterDto request,
                ...
                ) =>
            {
                ...
                var result = await service.CreateCommentCenterAsync(request,Id, httpContext.User.GetAuthorizedUserType().ToEnum<UserType>());
             ...
             .AddEndpointFilter(new ValidationFilter<CreateCommentCenterDto>()); ;
