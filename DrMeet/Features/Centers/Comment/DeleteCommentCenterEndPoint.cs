...
public static class DeleteCommentCenterEndPoint
{
    public class EndPoint : BaseEndpoint, IEndpoint
    {
        public void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapPost($"{ApiInfo.Prefix}/DeleteCommentCenter", handler: async (
                    ICenterService service,
                      [FromBody] DeleteCenterCommentDto request,
                ...
                ) =>
            {
                ...
                var result = await service.DeleteCommentCenterAsync(request,DoctorId);
             ...
             .WithTags(ApiInfo.Tag).AddEndpointFilter(new ValidationFilter<DeleteCenterCommentDto>()); ;
