...
public static class UpdateWorkTypesDoctor
{
    public class EndPoint : BaseEndpoint, IEndpoint
    {
        public void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapPost($"{ApiInfo.Prefix}/UpdateWorkTypesDoctor", handler: async (
                     IDoctorService doctorService,
                     [FromBody] UpdateWorkTypesDoctorRequestDto request
                ) =>
            {
               


                var result = await doctorService.UpdateWorkTypesDoctor(request);
            ...
            .AddEndpointFilter(new ValidationFilter<UpdateWorkTypesDoctorRequestDto>());
