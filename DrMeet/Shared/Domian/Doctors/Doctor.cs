...
public class Doctor : BaseEntityPerson
{
    ...
    public virtual ICollection<CenterDoctorServicePricing> CenterDoctorServicePricing { get; set; } = [];
    public virtual ICollection<DoctorSocialMediaAccount> DoctorSocialMediaAccounts { get; set; } = [];
